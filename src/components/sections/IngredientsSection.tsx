      ...
      <motion.div className="w-full h-full relative" style={{ transformStyle: 'preserve-3d' }}
        ...
        <div className="absolute inset-0 rounded-3xl overflow-hidden group"
          style={{
            ...
            boxShadow: `0 1px 0 rgba(124,58,237,0.09) inset, 0 32px 80px rgba(0,0,0,0.6), 0 0 0 1px rgba(0,0,0,0.3)`,
          ...
          <div className="p-7 h-full flex flex-col relative z-10">
            ...
            <div className="mt-5">
              ...
              <div className="h-1 rounded-full overflow-hidden" style={{ background: 'rgba(124,58,237,0.09)' }}>
        ...
        <div className="absolute inset-0 rounded-3xl"
          style={{
            ...
            boxShadow: `0 1px 0 rgba(124,58,237,0.07) inset, 0 32px 80px rgba(0,0,0,0.6)`,
            backfaceVisibility: 'hidden', WebkitBackfaceVisibility: 'hidden',
