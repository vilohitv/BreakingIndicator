      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <motion.div ref={ref} initial={{ opacity: 0, y: 32 }} animate={isVisible ? { opacity: 1, y: 0 } : {}}
          ...
          <h2 className="font-display font-bold leading-none mb-6" style={{ fontSize: 'clamp(2.4rem, 5.5vw, 4.5rem)' }}>
            <span style={{ color: 'rgba(255,255,255,0.90)' }}>Red Onion </span>
          ...
          <div>
              ...
              {(['skin', 'flesh'] as const).map((v) => (
                <button
                  ...
                  style={{
                    ...
                    color: variant === v ? 'rgba(255,255,255,0.95)' : 'rgba(255,255,255,0.50)',
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                style={{ background: 'rgba(124,58,237,0.05)', border: '1px solid rgba(124,58,237,0.12)', color: 'rgba(255,255,255,0.50)' }}
              >
                {variant === 'skin'
